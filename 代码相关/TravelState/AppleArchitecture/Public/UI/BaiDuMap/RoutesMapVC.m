...
@interface RoutesMapVC ()

@end

@implementation RoutesMapVC

//-----------------------------标准方法------------------
- (id) initWithNibName:(NSString *)aNibName bundle:(NSBundle *)aBuddle {
    if (IS_IPHONE_5) {
                self = [super initWithNibName:@"RoutesMapVC_2x" bundle:aBuddle];
    }else{
        self = [super initWithNibName:@"RoutesMapVC" bundle:aBuddle];
    }
    if (self != nil) {
