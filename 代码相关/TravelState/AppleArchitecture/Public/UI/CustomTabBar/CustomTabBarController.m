...
- (id)initWithViewControllers:(NSArray *)vcs imageArray:(NSArray *)arr;
{
	...
	if (self != nil)
	{
        ...
        _tabBar = [[CustomTabBar alloc] initWithFrame:CGRectMake(0, _containerView.frame.size.height - kTabBarHeight- kNaviBarHeight, 320.0f, kTabBarHeight) buttonImages:_imagesArr];
