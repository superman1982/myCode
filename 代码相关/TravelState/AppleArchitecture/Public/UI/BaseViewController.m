...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
     ...
     if (IS_IOS7)
        ...
        mViewManager.baseViewController = self;
...
- (void)didReceiveMemoryWarning {
    ...
    // 如果出现内存警告，除当前的View，其它的全都释放掉
//    [mViewManager freeBaseView: [mViewManager getCurrBaseViewName]];
//    [ViewControllerManager freeBaseViewController:[ViewControllerManager getCurrentBaseViewController]];
