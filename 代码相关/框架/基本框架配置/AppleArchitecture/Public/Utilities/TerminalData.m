...
+ (id) allocWithZone: (NSZone *)zone {
    return SAFE_ARC_RETAIN([self instanceTerminalData]);
}
...
- (void)applicationInit{
    ...
    CLLocationCoordinate2D userCoord = CLLocationCoordinate2DMake(30.630415, 104.050654);
