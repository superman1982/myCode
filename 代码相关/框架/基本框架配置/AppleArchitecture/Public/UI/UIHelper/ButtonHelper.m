...
+(UIButton *)createButtonWithFrame:(CGRect)aFrame
    ...
    [vButton setTitle:aTitle forState:UIControlStateNormal];
    [vButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [vButton setBackgroundImage:aNImage forState:UIControlStateNormal];
    [vButton setBackgroundImage:aHImage forState:UIControlStateHighlighted];
    [vButton addTarget:delegate action:aSel forControlEvents:UIControlEventTouchUpInside];
    return vButton;
}
