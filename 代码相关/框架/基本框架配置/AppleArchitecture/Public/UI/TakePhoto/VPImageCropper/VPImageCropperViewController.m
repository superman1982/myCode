...
#else
- (void)dealloc {
    SAFE_ARC_RELEASE(_showImgView);
    SAFE_ARC_RELEASE(_originalImage);
    SAFE_ARC_RELEASE(_editedImage);
    SAFE_ARC_RELEASE(_overlayView);
    SAFE_ARC_RELEASE(_ratioView);
    [super dealloc];
}
#endif
