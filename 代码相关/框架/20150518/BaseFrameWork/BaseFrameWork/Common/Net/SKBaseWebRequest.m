...
-(void)requestData{
    ...
    self.requestOperation = [SKNetManager postURLData:@"http://211.157.139.215:9999/seeyon/servlet/SeeyonMobileBrokerServlet?serviceProcess=A6A8_Common&responseCompress=gzip" Parameter:self.param.requestDic Success:^(id responseObject, NSError *error) {
