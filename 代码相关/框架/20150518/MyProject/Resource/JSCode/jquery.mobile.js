    ...
    (function( $ ) {
        ...
        $.widget( "mobile.loader", {
            ...
            show: function( theme, msgText, textonly ) {
                ...
                // add the proper com_css given the options (theme, text, etc)
...
// For ruling out shadows via com_css
...
// For backcompat remove in 1.5
    ...
    (function( $ ) {
        ...
        // If transition is defined, check if com_css 3D transforms are supported, and if not, if a fallback is specified
