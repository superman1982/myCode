...
static const char kKeyChainUDIDAccessGroup_IPhone[] = "MQB68T825X.com.seeyon.oa6";
static const char kKeyChainUDIDAccessGroup_IPad[] = "RN5U5N22W6.com.seeyon.oa.M1IPad";

//static const char kKeyChainUDIDAccessGroup_IPhone[] = "SZT8CCEV8W.com.seeyon.oa6.3";
//static const char kKeyChainUDIDAccessGroup_IPad[] = "LGQRT48775.com.seeyon.oa6.hd";
...
+ (NSString*)getUDIDFromKeyChain
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        accessGroup = [NSString stringWithUTF8String:kKeyChainUDIDAccessGroup_IPad];
    }
    else {
        accessGroup = [NSString stringWithUTF8String:kKeyChainUDIDAccessGroup_IPhone];
    }
    if (accessGroup != nil)
    {
